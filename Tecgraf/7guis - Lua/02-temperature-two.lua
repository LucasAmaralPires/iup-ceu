...
function Temperature ()
  local txt_celcius = iup.text{size = "60", mask = "[+/-]?(/d+/.?/d*|/./d+)"}
  local lbl_celcius = iup.label{title = "Celcius = "}

  local txt_fahrenheit = iup.text{size = "60", mask = "[+/-]?(/d+/.?/d*|/./d+)"}
  local lbl_fahrenheit = iup.label{title = "Fahrenheit"}
